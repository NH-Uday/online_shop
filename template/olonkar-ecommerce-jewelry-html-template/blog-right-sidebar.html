...
<head>
	<meta charset="UTF-8">
	<title>Olongkar | Blog Right Sidebar</title>
			...
			<div class="col-sm-8 col-md-9">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="single-blog">
							<div class="content fix">
								<a class="image fix" href="blog-details.html"><img src="img/blog/blog-5.jpg" alt="" />
									<div class="date">
										<h4>25</h4>
										<h5>Aug</h5>
									</div>
					...
					<div class="col-md-6">
						<div class="single-blog">
							<div class="content fix">
								<a class="image fix" href="blog-details.html"><img src="img/blog/blog-6.jpg" alt="" />
									<div class="date">
										<h4>25</h4>
										<h5>Aug</h5>
									</div>
					...
					<div class="col-md-6">
						<div class="single-blog">
							<div class="content fix">
								<a class="image fix" href="blog-details.html"><img src="img/blog/blog-7.jpg" alt="" />
									<div class="date">
										<h4>25</h4>
										<h5>Aug</h5>
									</div>
					...
					<div class="col-md-6">
						<div class="single-blog">
							<div class="content fix">
								<a class="image fix" href="blog-details.html"><img src="img/blog/blog-8.jpg" alt="" />
									<div class="date">
										<h4>25</h4>
										<h5>Aug</h5>
									</div>
