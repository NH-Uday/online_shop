			...
			<div class="col-sm-6 col-md-5">
				...
				@endif
					<form id="login-form" method="post">
						...
						<div class="remember">
							<a class="collapsed" data-toggle="collapse" data-parent="#checkout-progress" href="#payment-met">Forgot Password ?</a>
						</div>
				...
				<div id="payment-met" class="panel-collapse collapse">
					<div class="panel-body">
						<div class="bill-info" id="forgetNameDiv">
							<p>Enter Username or Contact Information of Your Account:</p>
							<div class="group">
								<input type="text" id="forgetName" onchange="AccCon()" placeholder="Username / Phone Number" class="half"><br><button onclick="AccCon()"> Confirm Account </button>
							</div>
						</div>
					</div><br>
