						...
						<ul class="header-cart-pro">
							...
							<li>
								<div class="image">
									...
									@endforeach
									@if($imgCall==0) <a href="/product-details/{{$dt->prod_id}}" class="pro-image fix"><img src="img/cart-1.jpg" alt="cart item" /></a> @endif
								</div>
					...
					<nav>
						<ul>
							...
							<li><a href="/Coupon">Discount</a>
								<ul class="sub-menu">
									<li><a href="/Coupon">Rewards</a></li>
									<li><a href="/Coupon">Discount Coupons</a></li>
								</ul>
							</li>
							<li><a href="/aboutus">About Us</a></li>
							<li><a href="/contact">Contact</a></li>
...
<div class="support-area section fix"><!--Start Support Area-->
	<div class="container">
		<div class="row">
			<a class="collapsed" data-toggle="collapse" data-parent="#checkout-progress" href="#payment-met" onclick="hiders()">
			<div class="col-xs-6 col-sm-3">
				<div class="fun-factor">
					...
					<h4>Accounts ({{count($users)}})</h4>
				</div>
			</div></a>
			<a class="collapsed" data-toggle="collapse" data-parent="#checkout-progress" href="#proDIvs" onclick="hider()">
			<div class="col-xs-6 col-sm-3">
				<div class="fun-factor">
					<div class="fun-factor-in">
					...
					<h4>Products ({{count($prodData)}})</h4>
				</div>
			</div></a>
			<a class="collapsed" data-toggle="collapse" data-parent="#checkout-progress" href="#ordDIvs" onclick="hidert()">
			<div class="col-xs-6 col-sm-3">
				<div class="fun-factor">
					<div class="fun-factor-in">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="payment">
					<ul>
						<li><a href="/payments"><img src="img/footer/paypal.jpg" alt="" /></a></li>
						<li><a href="/payments"><img src="img/footer/visa.jpg" alt="" /></a></li>
						<li><a href="/payments"><img src="img/footer/master.jpg" alt="" /></a></li>
						<li><a href="/payments"><img src="img/footer/cards.jpg" alt="" /></a></li>
						<li><a href="/payments"><img src="img/footer/discover.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
		</div>
