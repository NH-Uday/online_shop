...
<div class="brand-area section fix"><!--Start Brand Area-->
	<div class="container">
		<div class="row">
			<div class="section-title">
				<h2><input type="text" style="color:black;" value="" placeholder="{{$SiteData[30]->data}}" id="ProdShowTitle6"/>
						<button><i style="color:lime;" class="fa fa-check" onclick="SiteChange('ProdShowTitle6')"></i></button></h2>
				<div class="underline"></div>
			</div>
