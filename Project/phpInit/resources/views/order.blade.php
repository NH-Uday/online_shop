				...
				<div class="panel-group" id="checkout-progress">
					...
					<div class="panel panel-default">
						<div class="panel-heading" >
							<a class="collapsed" data-toggle="collapse" data-parent="#checkout-progress" href="#bill-info"><span><i class="fa fa-download"></i></span>Your Previous Orders</a>
						</div>
						<div id="bill-info" class="panel-collapse collapse">
								...
								<div class="panel-body">
									<div class="bill-info">
										...
										@foreach($OrderData as $dt)
											<tr class="table-info">
												<td class="namedes">
													<h2><a href="">{{$dt->order_id}}</a></h2>
												</td>
												<td class="unit">
													<h5>Order Total Price : ${{$dt->grand_price}}</h5>
												</td>
												<td class="quantity">
													<h5>Created at : {{$dt->creation_date}}PM</h5>
												</td>
												<td class="valu">
													<h4><span>{{$dt->order_status}}<span></h4>
												</td>
											</tr>
											@endforeach
										</table>
							...
							@else
								<p class="confirm-data"> No order purchase history. </p>
							@endif
						</div>
					</div>
					@endif
					
					<div id="payment-met" class="">
						<div class="panel-body">
							<div class="bill-info">
								<p>Type Your Order ID :</p>
								<div class="group">
									<input type="text" placeholder="Example: XXXX-XX-XX-XXXXXX" class="third" id="ord" onchange="SrcOrder()"><button onclick="SrcOrder()"> Check </button>
								</div>
							</div><br>
							<div class="payment-met">
								<div class="pay" id="orderTab"></div>
							</div>
						</div>
					</div>
