...
<section class="blog-page page fix"><!-- Start Blog Area-->
	<div class="container">
		<div class="row">
			@foreach($couponDT as $dt)
			<div class="col-sm-6 col-md-4">
				<div class="single-blog">
					<div class="content fix">
						<a class="image fix" href="/shop/category/Category 3"><img src="img/blog/blog-1.jpg" alt="" />
							<div class="date"><br>
								@if($dt->percentage!=null)
								<h4>{{$dt->percentage}}%</h4>
								@else
								<h4>${{$dt->amount}}</h4>
								@endif
								<h2 style="color:orange;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAwesome&nbspCashback&nbspOffer </h2>
							</div> 
						</a>
						<h2><a class="title" href="/">{{$dt->coupon_name}}</a></h2>
						<div class="meta">
							<a href=""><i class="fa fa-pencil-square-o"></i>{{$dt->code}}</a>
							@if($dt->shop_name!=null)<a href=""><i class="fa fa-calendar"></i>{{$dt->shop_name}}</a>@endif
						</div>
					</div>
				</div>
			</div><br><br><br><br>
