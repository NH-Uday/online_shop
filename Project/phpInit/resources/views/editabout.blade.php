      ...
      <div class="col-sm-6 col-md-5">
        <div class="login">
          <form id="accountform" action="/AddProduct" method="post" name="reg">@csrf
            ...
            <label id="prodnameLbl"><strong>Welcome Note</strong><span>*</span></label>
            <textarea value="" rows="8" cols="63" type="text" name="wnote" style="background:transparent;border:1px solid Silver;"></textarea><br>
            <label id="prodnameLbl"><strong>Hightlight</strong><span>*</span></label>
            <textarea value="" rows="8" cols="63" type="text" name="highlight" style="background:transparent;border:1px solid Silver;"></textarea><br>
            <label id="prodnameLbl"><strong>Why Choose this website?</strong><span>*</span></label>
            <textarea value="" rows="8" cols="63" type="text" name="highlight" style="background:transparent;border:1px solid Silver;"></textarea><br>
            <div class="form-group mt-3">
              <label class="mr-2" id="prodpicLb7"><strong>Highlighted image for the page</strong></label>
