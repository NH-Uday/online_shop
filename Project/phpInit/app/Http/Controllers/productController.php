...
class productController extends Controller
{
    ...
    public function auth($id = null, Request $req){
		...
		if( $req->session()->has('id') ){
			...
			return view('/product-details',['prodData'=>$product, 'stock'=>$stock, 'relatedProduct'=>$relatedProduct, 'userData'=>$userData, 'imgData'=>$imgData, 'historyData'=>$historyData, 'CartData'=>$CartData, 'SiteData'=>$SiteData, 'proRev'=>$proRev, 'TimeData'=>$TimeData, 'proImg'=>$proImg])->with(compact('product','stock','relatedProduct'));
			...
			return view('/product-details',['stock'=>$stock, 'prodData'=>$product, 'relatedProduct'=>$relatedProduct, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'proImg'=>$proImg, 'imgData'=>$imgData, 'proRev'=>$proRev])->with(compact('product','stock','relatedProduct'));
