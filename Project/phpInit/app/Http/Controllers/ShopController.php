...
class ShopController extends Controller
{
	public function Index($searchType, $value, $sorts=null, Request $req){
		...
		if( $req->session()->has('id') ){
			...
			return view('shop',['userData'=>$userData, 'historyData'=>$historyData, 'CartData'=>$CartData, 'searchResult'=>$searchResult, 'SearchData'=>$SearchData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'imgData'=>$imgData]);
			...
			return view('shop',['searchResult'=>$searchResult, 'SearchData'=>$SearchData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'imgData'=>$imgData]);
	...
	public function Index2($searchType, $value, $sorts=null, $min=null, $max=null, Request $req){
		...
		if( $req->session()->has('id') ){
			...
			return view('shop2',['userData'=>$userData, 'historyData'=>$historyData, 'CartData'=>$CartData, 'searchResult'=>$searchResult, 'SearchData'=>$SearchData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'imgData'=>$imgData]);
			...
			return view('shop2',['searchResult'=>$searchResult, 'SearchData'=>$SearchData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'imgData'=>$imgData]);
