...
class DashBoardController extends Controller
{
	public function index(Request $req){
		...
		if( $req->session()->has('id') ){
			...
			return view('DashBoard',['prodData'=>$getData, 'users'=>$users, 'userData'=>$userData, 'historyData'=>$historyData, 'imgData'=>$imgData, 'trendProd'=>$trendProd, 'CartData'=>$CartData, 'SiteData'=>$SiteData, 'TimeData'=>$TimeData, 'OrderData'=>$OrderData]);
